          ...
          return ListItemWidget(
            ...
            subtitle: Column(
              ...
              children: <Widget>[
                ...
                Text("Duration: ${Utility.parseToMinutesSeconds(int.parse(song.duration))}",
            ...
            trailing: (addToPlaylistAction == true) ? IconButton(
                          ...
                          builder: (context, snapshot){
                            ...
                            if (snapshot.hasData){
                              if (snapshot.data.isEmpty){
                                print("is Empty");
                                return NoDataWidget(title: "There is no playlists",);
                              }

                              return PlaylistDialogContent(
                                options: snapshot.data.map( (playlist) => playlist.name ).toList(),
                                onSelected: (index){
                                  snapshot.data[index].addSong(song: song);
...
class PlaylistDialogContent extends StatefulWidget {
  ...
  PlaylistDialogContent({@required this.options, this.onSelected, this.initialIndexSelected});
